                                    ...
                                    <Row>
                                        <Col md={3} lg={3} sm={6} xs={6}>
                                            <img className="cart-product-img"
                                                 src="https://rukminim1.flixcart.com/image/416/416/k2jbyq80pkrrdj/mobile-refurbished/u/z/t/iphone-11-256-c-mwmd2hn-a-apple-0-original-imafkg24wszdhzy3.jpeg?q=70"/>
                                        </Col>
                                ...
                                <Card.Body>
                                    <Row>
                                        <Col md={4} lg={4} sm={6} xs={6}>
                                            <h5> Total Item = 05 </h5>
                                            <h5>Total Price = 05 x 100 = 5000$</h5>
                                            <Button className="btn btn-block w-100 mt-3  site-btn"><i
